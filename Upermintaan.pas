...
Procedure TFrmPermintaan.ambilRuang;
var
...
procedure TFrmPermintaan.deleterow(mg:TStringGrid;ARow:integer);
var i,j,k:integer;
begin
        with mg do begin
...
procedure TFrmPermintaan.FormCreate(Sender: TObject);
begin
  KosongTex(True);
  dtp1.date:= now;
  dtp2.date:= now;
...
Procedure TFrmPermintaan.tambah_grid;
var
    addSat : TMyQuery;
begin
inc(counter);
...
Procedure TFrmPermintaan.cbo_satuan;
var
    qcom1 : TMyQuery;
begin
    try
...
Procedure TFrmPermintaan.jumlah_permintaan;
...
Procedure TFrmPermintaan.aturgrid2;
...
Procedure TFrmPermintaan.aturgrid1;
//var counter,hapus_baris : Integer;
begin
  counter:=0;
  hapus_baris:=0;
...
Procedure TFrmPermintaan.KosongTex(Kunci:Boolean);
//var
//j:Integer;
Begin
  if Kunci=True then
...
Procedure TFrmPermintaan.buatno;
var
  tgl,urut : string;
  i_no : integer;
  q_no: TMyQuery;
...
procedure TFrmPermintaan.SpeedButton2Click(Sender: TObject);
begin
btnnoreg.Text:=GetNoBBK;
end;

procedure TFrmPermintaan.btnBtnBaruClick(Sender: TObject);
begin
...
procedure TFrmPermintaan.cxButtonEdit1PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
 ...
 Procedure TFrmPermintaan.Tampil_combo_gudang;
 var
...
//QuotedStr(''+FMenu.dxStatusBar1.Panels[2].Text+'')+
  ...
  Procedure TFrmPermintaan.Tampil_combo_Petugas;
 var
...
procedure TFrmPermintaan.FormShow(Sender: TObject);
...
procedure TFrmPermintaan.btnBtnUbah1Click(Sender: TObject);
begin
...
procedure TFrmPermintaan.btnBtnHapusClick(Sender: TObject);
begin
PnOperasi.Caption := 'Hapus Data';
end;

procedure TFrmPermintaan.btcariClick(Sender: TObject);
var
...
procedure TFrmPermintaan.btn1Click(Sender: TObject);
begin
tambah_grid;
end;

procedure TFrmPermintaan.cxcariKeyPress(Sender: TObject; var Key: Char);
begin
if(Key=#13)then
	begin
    try
...
function TFrmPermintaan.Caribrg(nkode_cr: String):string;
var
  q6 : TMyStoredProc;
  dt:TListItem;
  //nSem:string;
...
procedure TFrmPermintaan.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FrmPermintaan:=nil;
  Action:=caFree;
end;

procedure TFrmPermintaan.lv1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPermintaan.lv1KeyPress(Sender: TObject; var Key: Char);
begin
try
		if(Key=#13)then
	begin
...
procedure TFrmPermintaan.edjmlKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmPermintaan.edjmlKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      {
...
procedure TFrmPermintaan.Total;
begin
JML_BRG:=0;
...
procedure TFrmPermintaan.ed2PropertiesChange(Sender: TObject);
begin
...
procedure TFrmPermintaan.hapus_grid;
begin
...
procedure TFrmPermintaan.btn2Click(Sender: TObject);
begin
 if (cek_baris='') then begin
...
procedure TFrmPermintaan.grid1SelectCell(Sender: TObject; ACol, ARow: Integer;
  var CanSelect: Boolean);
  var
    input_box : string;
begin
...
procedure TFrmPermintaan.Grid2DblClickCell(Sender: TObject; ARow, ACol: Integer);
begin
...
procedure TFrmPermintaan.grid1GetAlignment(Sender: TObject; ARow,
...
procedure TFrmPermintaan.grid1GetFloatFormat(Sender: TObject; ACol,
...
procedure TFrmPermintaan.ed_dtotalChange(Sender: TObject);
begin
   //formatRupiah(ed_dtotal);
   //edtotal.Text := ed_dtotal.Text;
end;

procedure TFrmPermintaan.grid1GetCellColor(Sender: TObject; ARow,
...
procedure TFrmPermintaan.tmr1Timer(Sender: TObject);
begin
...
procedure TFrmPermintaan.edjmlPropertiesChange(Sender: TObject);
begin
{
...
procedure TFrmPermintaan.chk1Click(Sender: TObject);
begin
      if chk1.Checked   THEN
      BEGIN
      ed2.Visible := True;
...
procedure TFrmPermintaan.btnsaveClick(Sender: TObject);
var
// simpan cbb
...
begin
  ...
  Procedure TFrmPermintaan.TampilData_permintaan;
  var
    q2p,q3p : TMyQuery;
    qd2p : TMyQuery;
  ...
  Procedure TFrmPermintaan.TampilData;
  var
    q2,q3 : TMyQuery;
    qd2 : TMyQuery;
    i2 : Integer;
...
Function TFrmPermintaan.GetNoBBK:string;
...
Function TFrmPermintaan.Lastkasir(s:string):string;
begin
QCari.Close;
...
procedure TFrmPermintaan.btn_penerimaPropertiesChange(Sender: TObject);
var
...
procedure TFrmPermintaan.btn_ruanganPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  FCarisp:=TFCarisp.Create(Application);
...
procedure TFrmPermintaan.btn_ruanganPropertiesChange(Sender: TObject);
begin
ambilRuang;
end;

procedure TFrmPermintaan.lv1CustomDrawItem(Sender: TCustomListView;
...
procedure TFrmPermintaan.grid1DrawCell(Sender: TObject; ACol, ARow: Integer;
  Rect: TRect; State: TGridDrawState);
  //var   S: string;
begin
...
procedure TFrmPermintaan.btnnoregPropertiesChange(Sender: TObject);
begin
Edkodetransaksi.Text := btnnoreg.Text;
end;

procedure TFrmPermintaan.SpeedButton3Click(Sender: TObject);
begin
// uRUT
   for i2:=1 to Grid1.RowCount-1 do begin
    Grid1.Cells[0,i2]:=IntToStr(i2);
...
procedure TFrmPermintaan.SpeedButton4Click(Sender: TObject);
begin
PnOperasi.Caption := 'Tambah Data';
//btnnoreg.Text:=GetNoBBK;
btnnoreg.Enabled:=False;
