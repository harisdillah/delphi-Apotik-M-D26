...
procedure TFrmPesanan.AdvcboDrawProp(Sender: TObject; RowIndex,
...
Procedure TFrmPesanan.ambilRuang;
var
...
procedure TFrmPesanan.deleterow(mg:TStringGrid;ARow:integer);
var i,j,k:integer;
begin
        with mg do begin
...
Procedure TFrmPesanan.tambah_grid;
var
    addSat : TMyQuery;
begin
inc(counter);
...
Procedure TFrmPesanan.cbo_satuan;
var
    qcom1 : TMyQuery;
begin
    try
...
Procedure TFrmPesanan.jumlah_permintaan;
...
Procedure TFrmPesanan.aturgrid2;
...
procedure TFrmPesanan.BitBtn1Click(Sender: TObject);
begin
TampilDataNocari;
end;

Procedure TFrmPesanan.aturgrid1;
//var counter,hapus_baris : Integer;
begin
  counter:=0;
  hapus_baris:=0;
...
Procedure TFrmPesanan.KosongTex(Kunci:Boolean);
//var
//j:Integer;
Begin
  if Kunci=True then
...
procedure TFrmPesanan.SpeedButton1Click(Sender: TObject);
begin
//if frm_mcv=nil then
...
procedure TFrmPesanan.SpeedButton2Click(Sender: TObject);
begin
btnnoreg.Text:=GetNoBBK;
end;

procedure TFrmPesanan.btnBtnBaruClick(Sender: TObject);
begin
...
procedure TFrmPesanan.cxButtonEdit1PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
...
// end;
  ...
  Procedure TFrmPesanan.Tampil_combo_Petugas;
 var
...
procedure TFrmPesanan.btnBtnUbah1Click(Sender: TObject);
begin
...
procedure TFrmPesanan.btnBtnHapusClick(Sender: TObject);
begin
PnOperasi.Caption := 'Hapus Data';
end;

procedure TFrmPesanan.btcariClick(Sender: TObject);
begin
TampilDatacari;
end;

procedure TFrmPesanan.btn1Click(Sender: TObject);
begin
tambah_grid;
end;

procedure TFrmPesanan.cxcariKeyPress(Sender: TObject; var Key: Char);
begin
if(Key=#13)then
	begin
    try
...
function TFrmPesanan.Caribrg(nkode_cr: String):string;
var
  q6 : TMyStoredProc;
  dt:TListItem;
  //nSem:string;
...
procedure TFrmPesanan.lv1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmPesanan.lv1KeyPress(Sender: TObject; var Key: Char);
begin
try
		if(Key=#13)then
	begin
...
procedure TFrmPesanan.edjmlKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmPesanan.edjmlKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
      {
...
procedure TFrmPesanan.ed2PropertiesChange(Sender: TObject);
begin
...
procedure TFrmPesanan.hapus_grid;
begin
...
procedure TFrmPesanan.btn2Click(Sender: TObject);
begin
 if (cek_baris='') then begin
...
procedure TFrmPesanan.grid1SelectCell(Sender: TObject; ACol, ARow: Integer;
  var CanSelect: Boolean);
  var
    input_box : string;
begin
...
procedure TFrmPesanan.Grid2DblClickCell(Sender: TObject; ARow, ACol: Integer);
begin
...
procedure TFrmPesanan.grid1GetAlignment(Sender: TObject; ARow,
...
procedure TFrmPesanan.grid1GetFloatFormat(Sender: TObject; ACol,
...
procedure TFrmPesanan.ed_dtotalChange(Sender: TObject);
begin
   //formatRupiah(ed_dtotal);
   //edtotal.Text := ed_dtotal.Text;
end;

procedure TFrmPesanan.grid1GetCellColor(Sender: TObject; ARow,
...
procedure TFrmPesanan.tmr1Timer(Sender: TObject);
begin
...
procedure TFrmPesanan.edjmlPropertiesChange(Sender: TObject);
begin
{
...
procedure TFrmPesanan.cxBtn_idcvChange(Sender: TObject);
var
...
procedure TFrmPesanan.cxBtn_idcvClickBtn(Sender: TObject);
begin
     FCarisp:=TFCarisp.Create(Application);
...
procedure TFrmPesanan.chk1Click(Sender: TObject);
begin
      if chk1.Checked   THEN
      BEGIN
      ed2.Visible := True;
...
procedure TFrmPesanan.btnsaveClick(Sender: TObject);
var
// simpan cbb
...
Procedure TFrmPesanan.TampilDataNocari;
  var
  ...
  Procedure TFrmPesanan.TampilDatacari;
  var
  spdata : TMyStoredProc;
  i : integer;
  begin
  ...
  Procedure TFrmPesanan.TampilData;
  var
    q2,q3 : TMyQuery;
    qd2 : TMyQuery;
    i2 : Integer;
...
Function TFrmPesanan.GetNoBBK:string;
...
Function TFrmPesanan.Lastkasir(s:string):string;
begin
QCari.Close;
...
procedure TFrmPesanan.btn_penerimaPropertiesChange(Sender: TObject);
var
...
procedure TFrmPesanan.btn_ruanganPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  FCarisp:=TFCarisp.Create(Application);
...
procedure TFrmPesanan.btn_ruanganPropertiesChange(Sender: TObject);
begin
ambilRuang;
end;

procedure TFrmPesanan.lv1CustomDrawItem(Sender: TCustomListView;
...
procedure TFrmPesanan.grid1DrawCell(Sender: TObject; ACol, ARow: Integer;
  Rect: TRect; State: TGridDrawState);
  //var   S: string;
begin
...
procedure TFrmPesanan.btnnoregPropertiesChange(Sender: TObject);
begin
Edkodetransaksi.Text := btnnoreg.Text;
end;

procedure TFrmPesanan.SpeedButton3Click(Sender: TObject);
begin
// uRUT
   for i2:=1 to Grid1.RowCount-1 do begin
    Grid1.Cells[0,i2]:=IntToStr(i2);
...
procedure TFrmPesanan.SpeedButton4Click(Sender: TObject);
begin
//PnOperasi.Caption := 'Tambah Data';
////btnnoreg.Text:=GetNoBBK;
//btnnoreg.Enabled:=False;
