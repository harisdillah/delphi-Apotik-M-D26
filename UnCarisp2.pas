...
procedure TFCarisp2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TFCarisp2.BtnCancelClick(Sender: TObject);
begin
  Close;
end;

procedure TFCarisp2.FormShow(Sender: TObject);
var
  I:integer;
begin
  CariSucces:=False;
...
procedure TFCarisp2.BtnSearchClick(Sender: TObject);
var
...
begin
  ...
  try
    ...
    AdDsCarisp.ParamByName('cari2').AsString := EGudang.Text;
    AdDsCarisp.Execute;
...
procedure TFCarisp2.BtnOkClick(Sender: TObject);
var
  i:integer;
begin
...
procedure TFCarisp2.LsCariDblClick(Sender: TObject);
begin
  BtnOkClick(BtnOk);
end;

procedure TFCarisp2.FormCreate(Sender: TObject);
begin
  Aktif:=False;
end;

procedure TFCarisp2.LsCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFCarisp2.LsCariCustomDrawItem(Sender: TCustomListView;
  Item: TListItem; State: TCustomDrawState; var DefaultDraw: Boolean);
var
  lst: TListView;
  i: integer;
...
procedure TFCarisp2.EdSearchKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFCarisp2.LsCariKeyPress(Sender: TObject; var Key: Char);
begin
try
		if(Key=#13)then
	begin
...
procedure TFCarisp2.LsFieldDrawItem(Control: TWinControl; Index: Integer;
  Rect: TRect; State: TOwnerDrawState);
  var Field: TField;
//begin
