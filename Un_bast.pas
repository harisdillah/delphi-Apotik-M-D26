...
uses UF_terbilang, un_modul,UnVariabel,uconfig,Un_detail,udbxls;
...
begin
try
     sppd.Connection := DmModul.MyCon1;
     sppd.Close;
...
try
    ...
    SPbast.Connection := DmModul.MyCon1;
    SPbast.Close;
...
frm_bast.Caption := apNamaAplikasi;
Aturgrid;
Aturgrid2;
RightEdit(edtEd_t1);
...
try
    ...
    SP_Detail.Connection := DmModul.Mycon1;
    SP_Detail.Close;
...
try
    Screen.cursor := crsqlWait;
    Frm_detail.SP_detailbrg.Connection := DmModul.Mycon1;
