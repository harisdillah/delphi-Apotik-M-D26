...
procedure TFrmBarang.tampil_form;
var
  qbrg : TMyQuery;
begin
...
procedure TFrmBarang.bidang_barang;
var q_bid : TMyQuery;
...
procedure TFrmBarang.jenis_barang;
var q_jns : TMyQuery;
...
procedure TFrmBarang.combo_sat;
var q_sat : TMyQuery;
...
procedure TFrmBarang.combo_penyedia;
var q_peny : TMyQuery;
...
procedure TFrmBarang.SpeedButton1Click(Sender: TObject);
var
...
procedure TFrmBarang.SpeedButton2Click(Sender: TObject);
var
 spxls : TMyStoredProc;
begin
...
procedure TFrmBarang.grid1GetCellColor(Sender: TObject; ARow,
...
procedure TFrmBarang.grid1GetFloatFormat(Sender: TObject; ACol,
...
procedure TFrmBarang.PnOperasi1Click(Sender: TObject);
var
  spdata : TMyStoredProc;
  i,counter : integer;
begin
...
procedure TFrmBarang.grid1DblClickCell(Sender: TObject; ARow,
  ACol: Integer);
begin
...
procedure TFrmBarang.btnnobaruClick(Sender: TObject);
begin
...
procedure TFrmBarang.btn2Click(Sender: TObject);
begin
...
procedure TFrmBarang.PnOperasi2Click(Sender: TObject);
begin
Pnket.Caption := 'Tambah Data';
end;

procedure TFrmBarang.PnOperasi3Click(Sender: TObject);
begin
Pnket.Caption := 'Ubah Data';
end;

procedure TFrmBarang.PnOperasi4Click(Sender: TObject);
begin
Pnket.Caption := 'hapus';
end;

procedure TFrmBarang.PnOperasi5Click(Sender: TObject);
var
  AdDsData : TMyQuery;
  i : Integer;
begin
